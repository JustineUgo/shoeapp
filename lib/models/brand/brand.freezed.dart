...
class _$BrandImpl implements _Brand {
  const _$BrandImpl({required this.name, required this.file});
  ...
  @override
  String toString() {
    return 'Brand(name: $name, file: $file)';
  }
...
abstract class _Brand implements Brand {
  const factory _Brand(
      {required final String name, required final String file}) = _$BrandImpl;
